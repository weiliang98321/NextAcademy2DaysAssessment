...
extension ListingScreenViewController : UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        //1.get the cell
        guard let cell = tableView.dequeueReusableCell(withIdentifier: "eventCell", for: indexPath) as? ListingScreenTableViewCell else { return UITableViewCell() }
...
extension ListingScreenViewController : UITableViewDelegate {
